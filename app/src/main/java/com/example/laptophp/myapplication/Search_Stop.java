...
public class Search_Stop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search__stop);
        ...
        time_recycler.setLayoutManager(new LinearLayoutManager(Search_Stop.this, LinearLayoutManager.VERTICAL, false));
    }
        ...
        data.getReference().child("Time").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data : dataSnapshot.getChildren()) {
                    ...
                    if (details.routeidd.equals(route_id) && details.stop_id.equals(stop_id)){
