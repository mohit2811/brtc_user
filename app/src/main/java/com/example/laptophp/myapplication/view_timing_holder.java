...
public class view_timing_holder extends RecyclerView.ViewHolder {

    TextView bus_id , route_from , route_to , stop , timing ;

    Button delete_route ;

    public view_timing_holder(View itemView) {
        super(itemView);
        ...
        delete_route = (Button) itemView.findViewById(R.id.delete_route);
    }
}
